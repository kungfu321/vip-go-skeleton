...
if(!defined('JOOMDEV_WPC_DIR')){
	define('JOOMDEV_WPC_DIR', 'wp-pros-cons');
}

define('JOOMDEV_WPC_MORE_THEMES_PLUGINS_URL', 'https://joomdev.com/wordpress-plugins');
...
register_uninstall_hook(__FILE__, ['wpc_uninstall', 'plugin_uninstall']);
