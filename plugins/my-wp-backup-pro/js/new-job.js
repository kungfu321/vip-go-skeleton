...
jQuery(function($) {
    ...
    $('#onedrive-token-link').click(function() {
        var win = window.open( MyWPBackupAuthUrl.onedrive, '_blank' );
        win.focus();
    });

    $('#push-token-link').click(function() {
        var win = window.open( MyWPBackupAuthUrl.push, '_blank' );
        win.focus();
    });
