	...
	class mts_recent_posts_widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				...
				sprintf( __('%sRecent Posts', 'cyprus' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ),
				array( 'description' => __( 'Display the most recent posts from all categories', 'cyprus' ) )
			);
		...
		public function form( $instance ) {
			...
			$title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : __( 'Recent Posts', 'cyprus' );
		...
		public function widget( $args, $instance ) {
			...
			echo self::get_cat_posts( $qty, $title_length, $comment_num, $date, $show_thumb2, $box_layout, $border_radius, $show_excerpt, $excerpt_length );
			echo $after_widget;
		}

		public function get_cat_posts( $qty, $title_length, $comment_num, $date, $show_thumb2, $box_layout, $border_radius, $show_excerpt, $excerpt_length ) {
