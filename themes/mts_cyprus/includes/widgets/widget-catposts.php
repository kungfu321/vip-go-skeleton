	...
	class single_category_posts_widget extends WP_Widget {
		...
		public function __construct() {
			parent::__construct(
				...
				sprintf( __( '%sCategory Posts', 'cyprus' ), MTS_THEME_WHITE_LABEL ? '' : 'MTS ' ),
				array( 'description' => __( 'Display the most recent posts from a single category', 'cyprus' ) )
			);
		...
		public function form( $instance ) {
			...
			$title          = isset( $instance['title'] ) ? $instance['title'] : __( 'Featured Category', 'cyprus' );
		...
		public function widget( $args, $instance ) {
			...
			echo self::get_cat_posts( $cat, $title_length, $qty, $comment_num, $date, $show_thumb1, $box_layout, $border_radius, $show_excerpt, $excerpt_length );
			echo $after_widget;
		}

		public function get_cat_posts( $cat, $title_length, $qty, $comment_num, $date, $show_thumb1, $box_layout, $border_radius, $show_excerpt, $excerpt_length ) {
