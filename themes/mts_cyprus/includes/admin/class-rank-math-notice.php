...
/**
 * Rank Math Notice
 * This class shows a special notice on admin Dashboard
 */

defined( 'WPINC' ) || exit;

class Rank_Math_Notice {

	/**
	 * Add hooks
	 */
	function __construct() {
		add_action( 'admin_notices', array( $this, 'rank_math_admin_notice' ) );
		add_action( 'admin_init', array( $this, 'rank_math_admin_notice_ignore' ) );
	}
	...
	function rank_math_admin_notice() {
		...
		if ( ! $rm_installed ) {
				$action  = __( 'Install for FREE', 'cyprus' );
				...
				$action  = __( 'Activate it now', 'cyprus' );
		...
		<div class="notice rm-notice welcome-panel plugin-card-seo-by-rank-math" id="try-rankmath-panel" style="clear:both;">
			<div class="welcome-panel-content" style="overflow:hidden;">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/includes/admin/assets/img/rank-math-banner.jpg" alt="Rank Math SEO" style="float: left;max-width: 343px;margin-right: 20px;margin-bottom: -60px;border: 5px solid #ededed;" />
				<div style="overflow: hidden; position: relative;">
					<h2><?php esc_html_e( 'The Future of WordPress SEO is Here!', 'cyprus' ); ?></h2>
					<p class="about-description"><?php echo esc_attr( 'The new Rank Math SEO plugin will help you rank better in the search results.', 'cyprus' ); ?></p>
					<ul>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Google Search Console Integration', 'cyprus' ); ?>
						</li>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Google Keyword Ranking', 'cyprus' ); ?>
						</li>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Google Keyword Suggestion', 'cyprus' ); ?>
						</li>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Google Schema Rich Snippets', 'cyprus' ); ?>
						</li>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Advanced SEO Analysis Tool', 'cyprus' ); ?>
						</li>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Automated Image SEO', 'cyprus' ); ?>
						</li>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'XML Sitemap', 'cyprus' ); ?>
						</li>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( '404 Monitor', 'cyprus' ); ?>
						</li>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Redirection Manager', 'cyprus' ); ?>
						</li>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Local SEO Optimization', 'cyprus' ); ?>
						</li>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'Lightweight', 'cyprus' ); ?>
						</li>
						<li>
							<i class="dashicons dashicons-yes"></i> <?php esc_html_e( 'and much more...', 'cyprus' ); ?>
						</li>
					</ul>
					...
					<div style="opacity:0.4;font-size:12px;position:absolute;bottom:15px;right:0;">
							<?php esc_html_e( 'A MyThemeShop Product.', 'cyprus' ); ?>
					</div>
				</div>
				<a class="welcome-panel-close" id="wp_try_rankmath_panel-hide" href="<?php echo add_query_arg( 'rank_math_admin_notice_ignore', '1' ); ?>" aria-label="<?php esc_attr_e( 'Dismiss the Rank Math panel', 'cyprus' ); ?>"><?php esc_html_e( 'Dismiss', 'cyprus' ); ?></a>
			...
			<script type="text/javascript">
				jQuery(document).ready( function($) {
					...
					installRankmathSuccess = function( response ) {
						...
						tryRankmathPanel.find('.install-now').text('<?php echo esc_js( __( 'Activating...', 'cyprus' ) ); ?>');
