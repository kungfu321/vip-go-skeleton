...
<header id="site-header" class="main-header header-<?php echo esc_attr( cyprus_get_settings( 'mts_header_style' ) ); ?> clearfix" role="banner" itemscope itemtype="http://schema.org/WPHeader">
	...
	<?php } ?>
		<div class="container">
			...
			<?php
			// Header Search icon.
			if ( ! empty( cyprus_get_settings( 'mts_header_search' ) ) ) {
			?>
			...
			<div id="secondary-navigation" class="secondary-navigation" role="navigation" itemscope itemtype="http://schema.org/SiteNavigationElement">
				<a href="#" id="pull" class="toggle-mobile-menu"><?php esc_html_e( 'Menu', 'cyprus' ); ?></a>
